...
public class WebLinks {
	...
	// private static String HTML_SERVER = "192.168.1.166:28443";
	...
	// private static String SERVER ="180.151.36.117:28443/CancerCare/control/";
	 ...
	 private static String SERVER = "supporthealth.com/CancerCare/control/";
	 private static String HTML_SERVER = "supporthealth.com";
	...
	public static final String LIST_OF_PROFILE = "editPartyProfile";
	...
	public static final String ListPatientSymtoms = "listPatientSymptom";

	public static final String UpdatePatientSymptom = "updatePatientSymptom";
	...
	public static final String DeleteNotes = "deleteNotes";

	public static final String UpdateSponsership = "updateSponsership";
