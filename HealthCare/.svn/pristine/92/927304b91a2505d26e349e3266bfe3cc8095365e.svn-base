...
public class SponsorRequestFragment extends BaseFragment implements
	...
	void PopulatePendingSponsorShip() {
		if (this.mPendingDataArray != null) {
			...
			if (this.mPendingDataArray == null || (this.mPendingDataArray != null && this.mPendingDataArray.size() == 0)) {
				UIUtilities.showConfirmationAlert(getActivity(),
						R.string.dialog_title_information,
						"No pending request found", R.string.dialog_button_Ok,
	...
	void PopulateApprovedSponsorShip() {
		...
		if (this.mApproveDataArray != null) {
			...
			if (this.mApproveDataArray == null || (this.mApproveDataArray != null && this.mApproveDataArray.size() == 0)) {
				UIUtilities.showConfirmationAlert(getActivity(),
						R.string.dialog_title_information,
						"No approved request found", R.string.dialog_button_Ok,
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
									int which) {
	...
	void PopulateRejectedSponsorShip() {
		if (this.mRejectedDataArray != null) {
			...
			if (this.mRejectedDataArray == null || (this.mRejectedDataArray != null && this.mRejectedDataArray.size() == 0)) {
				UIUtilities.showConfirmationAlert(getActivity(),
						R.string.dialog_title_information,
						"No rejected request found", R.string.dialog_button_Ok,
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
									int which) {
